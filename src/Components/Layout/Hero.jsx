...
const Hero = () => {
  ...
  return (
    <div className="m-18">
      ...
      <h1 className="text-1xl p-2 text-lime-400 font-bold md:text-5xl">
        Desarrollador Full-Stack
      </h1>
      <h2 className="text p-2 text-white md:text-base">
      ...
      <div className="mt-10 mb-10 flex items-center gap-4">
        <a
          href="#"
          aria-label="WhatsApp"
          className="flex h-11 w-11 items-center justify-center text-white backdrop-blur-md transition-transform hover:scale-120 group"
        >
          <svg
            viewBox="0 0 24 24"
            className="h-6 w-6 fill-current group-hover:text-lime-500 transition-colors"
            aria-hidden="true"
          >
        ...
        >
          <svg
            viewBox="0 0 24 24"
            className="h-6 w-6 fill-current group-hover:text-purple-500 transition-colors"
            aria-hidden="true"
          >
