...
const Hero = () => {
  return (
    <div className="m-18">
      <p className="text-xl p-2 text-white/75 md:text-2xl ">!hola soy Estiven!</p>
      <h1 className="text-1xl p-2 text-white/75 font-bold md:text-5xl">
        Desarrollador Full-Stack
      </h1>
      <h2 className="text p-2 text-white/75 md:text-base">
        Especializado en tecnologías web modernas,
        <br /> con fuerte en el desarrollo de aplicaciones web escalables y
        eficientes.
        <br /> y tambien en el diseño de interfaces de usuario atractivas.
      </h2>
      ...
      <div className="mt-10 mb-10 flex items-center gap-4">
        <a
          href="#"
          aria-label="WhatsApp"
          className="flex h-11 w-11 items-center justify-center  text-white backdrop-blur-md transition-transform hover:scale-120 "
        >
          <svg
            viewBox="0 0 24 24"
